...
namespace ShowTime.Controllers
{
    public class SeatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Seat_id,Seat_state,Seat_cost,Movie_id,Thea_id")] Seat seat)
        {
            ...
            ViewBag.Movie_id = new SelectList(db.Movies, "Movie_id", "Movie_name", seat.Movie_id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Seat_id,Seat_state,Seat_cost,Movie_id,Thea_id")] Seat seat)
        {
            if (ModelState.IsValid)
            {
